...
type SeniorReviewDialogMode = 'approve' | 'revision' | 'finance_return';
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: 'grey.50' }}>
      ...
      <Dialog open={reviewDialogOpen} onClose={closeReviewDialog} maxWidth="md" fullWidth>
        <DialogTitle>
          ...
          {reviewDialogMode === 'approve' && 'Approve and advance report'}
                  ...
                  <Box sx={{ mt: 2, p: 2, border: '1px solid #ccc', borderRadius: 1, bgcolor: '#fff0f5' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      <Typography variant="body2" component="div">
                        Senior staff: I have read and agree to the certification statement above
                      </Typography>
                    </Box>
                  </Box>
                )}
                  ...
                  <>
                    ...
                    {!requiresSupervisorCertification && (
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                        Weekly check-up reports do not require the certification step.
                      </Typography>
                    )}
                  </>
                )}

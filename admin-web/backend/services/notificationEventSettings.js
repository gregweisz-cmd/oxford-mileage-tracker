...
const NOTIFICATION_EVENT_DEFINITIONS = {
  ...
  finance_revision_supervisor: {
    displayName: 'Finance requested revisions (legacy supervisor observer)',
    description: 'Legacy event for notifying a supervisor when finance requests changes. New revision routing uses the employee and observer events below.',
    notificationType: 'revision_requested',
    placeholders: ['employeeName', 'monthName', 'actorName'],
  },
  supervisor_revision_employee: {
    displayName: 'Supervisor requested revisions (legacy employee)',
    description: 'Legacy event for notifying the employee when a supervisor requests revisions. New revision routing uses the employee and observer events below.',
    notificationType: 'revision_requested',
    placeholders: ['employeeName', 'monthName', 'actorName'],
  },
  expense_revision_employee: {
    displayName: 'Expense report revision requested - employee',
    description: 'Notifies the employee when any approver sends their expense report back for revision.',
    notificationType: 'revision_requested',
    placeholders: ['employeeName', 'monthName', 'actorName'],
  },
  expense_revision_observer: {
    displayName: 'Expense report revision requested - observers',
    description: 'Notifies supervisor and senior staff observers when another approver sends a report back to the employee. Finance is not notified for pre-finance revisions.',
    notificationType: 'revision_requested',
    placeholders: ['employeeName', 'monthName', 'actorName'],
  },

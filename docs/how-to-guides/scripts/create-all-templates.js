/**
 * Script to create all PDF guide templates
 * This script generates HTML templates for all user guides
 */
...
function createTemplateHTML(title, content) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
console.log('Template creation script ready. Individual templates will be created with full content.');
